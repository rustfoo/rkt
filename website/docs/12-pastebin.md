---
sidebar_position: 14
sidebar_label: "Pastebin Tutorial"
---
...
Then add the usual rkt dependencies to the `Cargo.toml` file:
...
[Responder](https://docs.rs/rkt/latest/rkt/response/trait.Responder.html#provided-implementations)
...
[`Data::open()`]: https://docs.rs/rkt/latest/rkt/data/struct.Data.html#method.open
[`DataStream`]: https://docs.rs/rkt/latest/rkt/data/enum.DataStream.html
[`DataStream::into_file()`]: https://docs.rs/rkt/latest/rkt/data/enum.DataStream.html#method.into_file
[`uri!`]: https://docs.rs/rkt/latest/rkt/macro.uri.html
[`kibibytes()`]: https://docs.rs/rkt/latest/rkt/data/trait.ToByteUnit.html#method.kibibytes
[`ToByteUnit`]: https://docs.rs/rkt/latest/rkt/data/trait.ToByteUnit.html
[`UriDisplayPath`]: https://docs.rs/rkt/latest/rkt/derive.UriDisplayPath.html
...
through some of them to get a better feel for Rocket. Here are some ideas:
  ...
  * Use the [`local` module](https://docs.rs/rkt/latest/rkt/local/) to write unit tests for your
    pastebin.
