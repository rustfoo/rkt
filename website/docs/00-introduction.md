...
rkt is a web framework for Rust. If you'd like, you can think of rkt as
...
[Yesod](https://www.yesodweb.com/). We prefer to think of rkt as something
new. rkt aims to be fast, easy, and flexible while offering guaranteed safety
and security where it can. Importantly, rkt also aims to be _fun_, and it
...
rkt. After reading this guide, you should find yourself being very
productive with rkt.
...
rkt's design is centered around three core philosophies:
  ...
  * **Security, correctness, and developer experience are paramount.**
    ...
    a degraded developer experience. rkt is easy to use while taking great
  ...
  * **All request handling information should be typed and self-contained.**
    ...
    to native types. rkt does this for you with zero programming overhead.
    What's more, rkt's request handling is **self-contained** with zero
  ...
  * **Decisions should not be forced.**
    ...
    pluggable, optional components. While rkt has official support and
    libraries for each of these, they are completely optional and swappable.

These three ideas dictate rkt's interface, and you will find all of them
embedded in rkt's core features.
