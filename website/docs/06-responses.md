...
[`Response`]: https://docs.rs/rkt/latest/rkt/response/struct.Response.html
...
[`Accepted`]: https://docs.rs/rkt/latest/rkt/response/status/struct.Accepted.html
[`content::RawJson`]: https://docs.rs/rkt/latest/rkt/response/content/struct.RawJson.html
[`status::Custom`]: https://docs.rs/rkt/latest/rkt/response/status/struct.Custom.html
[`serde::json::Json`]: https://docs.rs/rkt/latest/rkt/serde/json/struct.Json.html
[custom responder]: #custom-responders
[`status` module]: https://docs.rs/rkt/latest/rkt/response/status/
[`content` module]: https://docs.rs/rkt/latest/rkt/response/content/
...
[`Responder` derive]: https://docs.rs/rkt/latest/rkt/derive.Responder.html
[`ContentType`]: https://docs.rs/rkt/latest/rkt/http/struct.ContentType.html
...
[`status`]: https://docs.rs/rkt/latest/rkt/response/status/
[`content`]: https://docs.rs/rkt/latest/rkt/response/content/
[`response`]: https://docs.rs/rkt/latest/rkt/response/
[`NamedFile`]: https://docs.rs/rkt/latest/rkt/fs/struct.NamedFile.html
...
[`stream`]: https://docs.rs/rkt/latest/rkt/response/stream/index.html
[`stream!`]: https://docs.rs/rkt/latest/rkt/response/stream/macro.stream.html
...
[`Origin`]: https://docs.rs/rkt/latest/rkt/http/uri/struct.Origin.html
[`Part`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/trait.Part.html
[`Uri`]: https://docs.rs/rkt/latest/rkt/http/uri/enum.Uri.html
[`Redirect::to()`]: https://docs.rs/rkt/latest/rkt/response/struct.Redirect.html#method.to
[`uri!`]: https://docs.rs/rkt/latest/rkt/macro.uri.html
[`UriDisplay`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/trait.UriDisplay.html
[`FromUriParam`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/trait.FromUriParam.html
[`Path`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/enum.Path.html
[`Query`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/enum.Query.html
[`Ignorable`]: https://docs.rs/rkt/latest/rkt/http/uri/fmt/trait.Ignorable.html
[`UriDisplayPath`]: https://docs.rs/rkt/latest/rkt/derive.UriDisplayPath.html
[`UriDisplayQuery`]: https://docs.rs/rkt/latest/rkt/derive.UriDisplayQuery.html
