...
import remarkRustHiddenLines from './src/plugins/remark-rust-hidden-lines.js';
...
const config = {
  title: 'rkt',
  tagline: 'A community fork of the Rocket web framework for Rust',
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/rustfoo/rkt',
            label: 'GitHub',
            position: 'right',
          },
        ],
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} rkt contributors. Built with Docusaurus.`,
      },
      prism: {
